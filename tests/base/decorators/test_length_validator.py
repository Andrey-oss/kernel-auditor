...
def test_max_func_with_valid_data():
    ...
    assert dummy_max_func('tex')['status'] == 'success'

def test_max_func_with_invalid_data():
    '''Test min validator, where requirements won't be satisfied'''

    assert dummy_max_func('test') != 'success'
